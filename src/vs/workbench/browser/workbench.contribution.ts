	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.editor.limit.enabled': {
				'type': 'boolean',
				'default': false,
				'description': nls.localize('limitEditorsEnablement', "Controls if the number of opened editors should be limited or not. When enabled, less recently used editors may close to make space for newly opening editors.")
			},
			'workbench.editor.limit.value': {
				'type': 'number',
				'default': 10,
				'exclusiveMinimum': 0,
				'description': nls.localize('limitEditorsMaximum', "Controls the maximum number of visible editors across all editor groups. Once the number of opened editors exceeds this number, less recently used editors may close automatically.")
			},
